...
export const OpenIn = ({ query, ...props }) => (
  <OpenInContext.Provider value={{ query }}>
    <DropdownMenu {...props} />
  </OpenInContext.Provider>
);

export const OpenInContent = ({ className, ...props }) => (
  <DropdownMenuContent
    align="start"
...
export const OpenInItem = (props) => <DropdownMenuItem {...props} />;

export const OpenInLabel = (props) => <DropdownMenuLabel {...props} />;

export const OpenInSeparator = (props) => <DropdownMenuSeparator {...props} />;
